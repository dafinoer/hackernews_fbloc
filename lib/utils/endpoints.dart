...
class Endpoint {
  ...
  static const String TOP = '/v0/topstories.json?print=pretty';
  static const String NEWS_IDS = '/v0/newstories.json?print=pretty';
  static const String JOBS = '/v0/jobstories.json?print=pretty';
